...
@section('tab_name', __('admin.features'))
@section('content')
    @include('admin.layouts.title', [
        'subTitle' => trans('common.list') . ' ' . trans('titles.features'),
        'title' => trans('titles.features'),
        'createBtn' => true,
        'btnTitle' => trans('common.add'),
        'btnUrl' => route('admin.features.create'),
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('admin.content.features.search')
                    <hr />
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                <a class="btn btn-sm btn-outline-warning"
                                                    href="{{ route('admin.features.edit', $item->id) }}">
                                                    <i class="mdi mdi-pencil font-size-18"></i>
                                                </a>

                                                <form action="{{ route('admin.features.destroy', $item->id) }}"
