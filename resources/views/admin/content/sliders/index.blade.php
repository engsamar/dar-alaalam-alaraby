...
@section('tab_name', __('titles.sliders'))
@section('content')
    @include('admin.layouts.title', [
        'subTitle' => trans('common.list') . ' ' . trans('titles.sliders'),
        'title' => trans('titles.sliders'),
        'createBtn' => true,
        'btnTitle' => trans('common.add'),
        'btnUrl' => route('admin.sliders.create'),
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('admin.content.sliders.search')
                    <hr />
