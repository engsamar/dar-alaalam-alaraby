...
@section('tab_name', __('admin.questions'))
@section('content')
    @include('admin.layouts.title', [
        'subTitle' => trans('common.list') . ' ' . trans('titles.questions'),
        'title' => trans('titles.questions'),
        'createBtn' => true,
        'btnTitle' => trans('common.add'),
        'btnUrl' => route('admin.questions.create'),
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('admin.content.questions.search')
                    <hr />
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                <a class="btn btn-sm btn-outline-warning"
                                                    href="{{ route('admin.questions.edit', $item->id) }}">
