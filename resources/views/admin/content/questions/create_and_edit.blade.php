...
@section('tab_name', trans('titles.questions'))
@section('css')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    @if ($item->id)
                        <form class="needs-validation" action="{{ route('admin.questions.update', $item->id) }}" method="POST"
                            enctype='multipart/form-data' novalidate>
                            <input type="hidden" name="_method" value="PUT">
                        @else
                            <form class="needs-validation" action="{{ route('admin.questions.store') }}" method="POST"
                                enctype='multipart/form-data' novalidate>
                    @endif
                    @csrf
                    ...
                    @if (!empty($locales))
                        @foreach ($locales as $Key => $locale)
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-10">
                                    <div class="form-group">
                                        <textarea rows="10" required id="description_{{ $Key }}-field" type="text"
                    ...
                    <div class="col-md-12">
                        ...
                        <a class="btn btn-danger pull-right text-white" style="float: right;"
                            href="{{ route('admin.questions.index') }}">@lang('common.cancel')
