...
@section('tab_name', __('admin.catalogues'))
@section('content')
    @include('admin.layouts.title', [
        'subTitle' => trans('common.list') . ' ' . trans('titles.catalogues'),
        'title' => trans('titles.catalogues'),
        'createBtn' => true,
        'btnTitle' => trans('common.add'),
        'btnUrl' => route('admin.catalogues.create'),
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('admin.article.catalogues.search')
                    <hr />
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                <a class="btn btn-sm btn-outline-warning"
                                                    href="{{ route('admin.catalogues.edit', $item->id) }}">
