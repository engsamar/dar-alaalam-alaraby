...
@section('tab_name', __('admin.articles'))
@section('content')
    @include('admin.layouts.title', [
        'subTitle' => trans('common.list') . ' ' . trans('titles.articles'),
        'title' => trans('titles.articles'),
        'createBtn' => true,
        'btnTitle' => trans('common.add'),
        'btnUrl' => route('admin.articles.create'),
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('admin.article.articles.search')
                    <hr />
