...
@section('tab_name', __('admin.colors'))
@section('content')
    @include('admin.layouts.title', [
        'subTitle' => trans('common.list') . ' ' . trans('titles.colors'),
        'title' => trans('titles.colors'),
        'createBtn' => true,
        'btnTitle' => trans('common.add'),
        'btnUrl' => route('admin.colors.create'),
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('admin.product.colors.search')
                    <hr />
                            ...
                            <table class="table align-middle table-nowrap table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('attributes.color_code')</th>
                                ...
                                <tbody>
                                    @foreach ($result['items'] as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->title ?? '' }}</td>
                                            <td>{!! $item->position !!}</td>
                                            <td style="width:40px;background: {{ $item->color_code }} !important"></td>
                                            ...
                                            <td class="text-left">
                                                ...
                                                <a class="btn btn-sm btn-outline-warning"
                                                    href="{{ route('admin.colors.edit', $item->id) }}">
