...
@section('tab_name', trans('titles.categories'))
@section('css')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    @if ($item->id)
                        <form class="needs-validation" action="{{ route('admin.categories.update', $item->id) }}"
                    ...
                    <div class="col-md-12">
                        ...
                        <a class="btn btn-danger pull-right text-white" style="float: right;"
                            href="{{ route('admin.categories.index') }}">@lang('common.cancel')
