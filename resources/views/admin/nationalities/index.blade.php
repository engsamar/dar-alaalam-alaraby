...
@section('tab_name', __('admin.nationalities'))
@section('content')
    @include('admin.layouts.title', [
        'subTitle' => trans('common.list') . ' ' . trans('titles.nationalities'),
        'title' => trans('titles.nationalities'),
        'createBtn' => true,
        'btnTitle' => trans('common.add'),
        'btnUrl' => route('admin.nationalities.create'),
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('admin.nationalities.search')
                    <hr />
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                <a class="btn btn-sm btn-outline-warning"
                                                    href="{{ route('admin.nationalities.edit', $item->id) }}">
                                                    <i class="mdi mdi-pencil font-size-18"></i>
                                                </a>

                                                <form action="{{ route('admin.nationalities.destroy', $item->id) }}"
