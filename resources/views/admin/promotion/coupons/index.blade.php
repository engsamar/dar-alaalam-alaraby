...
@section('tab_name', __('admin.coupons'))
@section('content')
    @include('admin.layouts.title', [
        'subTitle' => trans('common.list') . ' ' . trans('titles.coupons'),
        'title' => trans('titles.coupons'),
        'createBtn' => true,
        'btnTitle' => trans('common.add'),
        'btnUrl' => route('admin.coupons.create'),
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('admin.promotion.coupons.search')
                    <hr />
                            ...
                            <table class="table align-middle table-nowrap table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('attributes.code')</th>
                                        <th>@lang('attributes.no_usage')</th>
